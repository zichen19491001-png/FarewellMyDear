;メッセージレイヤの定義
		...
		[position width=1240 height=237 top=417 left=20 ]
			...
			[position page=fore frame="frame_message.png" margint=45 marginl=10 marginr=20 marginb=10 vertical=false opacity="180" ]
		

		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=30 x=30 y=430 bold="bold" edge="undefined" shadow="undefined"]
